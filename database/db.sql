...
CREATE TABLE `trips_stops` (
  ...
  PRIMARY KEY (`tripId`,`startDate`,`endDate`,`locationId`),
  CONSTRAINT `trips_stops_tripId` FOREIGN KEY (`tripId`) REFERENCES `trips` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-08-04  1:43:14
